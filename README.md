...
│   │   └── BagCatalog.swift      # Phase 5.3d — bag tier ladder (5 tiers: 20/30/40/55/75 slots), estate-tier gates per step, hide + iron materials only
│   │
│   ├── Migrations/
│   │   ├── CreateUser.swift
