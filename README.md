...
│   │   ├── SessionCache.swift
│   │   ├── Lingo+Locales.swift
│   │   ├── EphemeralChatState.swift  # in-memory actor — tracks transient mode-picker message IDs per user, plus pending warehouse withdraw-N state and the latest status-banner message ID
│   │   └── DotEnv+Env.swift
│   │
│   ├── entrypoint.swift
│   ├── configure.swift
