...
│   │   ├── User.swift
│   │   ├── Item.swift            # static item catalog (code, not DB) — Phase 5.2 added the Forester's leather set; gear.leather_vest retired into gear.forester_jerkin
│   │   ├── Recipe.swift          # Phase 5.2 — static crafting catalog (RecipeCategory forge/tannery, RecipeIngredient, RecipeOutput, Recipe, RecipeCatalog)
