...
│   │   ├── ExplorationService.swift # step outcome roll + autobattle stub + loot drops. Also the one place a walked km is counted (`user.recordWalk(toKm:)`) — every kind of step comes through here
