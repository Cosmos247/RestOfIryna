...
│   │   ├── User.swift
│   │   ├── Item.swift            # static item catalog (code, not DB) — Phase 5.2 added the Forester's leather set; Phase 5.2.1 added 6 cooked dishes + 6 recipe scrolls + Item.teachesRecipe field
...
│   │   ├── LearnedRecipe.swift   # Phase 5.2.1 — Fluent model: per-user known-recipe set (user_id, recipe_id, learned_at). has/add/allIds/ensureStarters helpers
