...
│   │   ├── CapitalController.swift       # Phase 6.0–6.5 — travel-gated hub, split across two streets since 2026-09-20 (👑 Замкова: Базар / Ристалище / Гільдії · 🏘 Поділ: Крамар / Майстер / Шинок / Ворожка · the square holds only the two roads); Trader (buy/sell + ✏️ N) + Tavern (food + dice/darts) + Fortune Teller + Master (armor buy/repair/enchant) + Market/Базар (player-to-player listings + 🤝 Trade); 1 stub left (Arena)
