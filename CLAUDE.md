...
- `Swift/Migrations/` — CreateUser, AddCharacterFields, AddProfileStyle, AddGameStats, CreateInventory, RemoveCrownsField, AddEquipSlotToInventory, AddGearBonuses, CreateWarehouse, CreateExplorationState, AddExplorationReturnState, AddHpRegenTick, AddPassiveExpeditionFields, RenameMaterialIds, RenameFoodIds
