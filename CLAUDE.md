...
**Basic actions (4.1):** **Attack** (−2 hunger) `applyAttack(player→enemy)` then enemy counter; **Defend** (−1) chip damage to enemy + doubled effectiveDEF on incoming; **Flee** (−3) 50% flat with forced full-damage counter on fail.
