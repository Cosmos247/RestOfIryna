...
- `Localizations/` — `en.json`, `uk.json` (~207 keys each). `exploration.find.<item_id>` keys carry per-item foraging flavor text used by the active-mode loot narrator.
