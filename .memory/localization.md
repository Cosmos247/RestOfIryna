...
- Mode exclusivity (Phase 3.4): commands.explore.busy (main keyboard Explore label while any expedition is in progress), capital.blocked_by_expedition (capital entry guard notice)
