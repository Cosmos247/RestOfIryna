...
- [Rebalance](rebalance.md) — **Active work.** Audit findings, locked decisions, the calibrated math model, the phase tracker (3–8 done, 9 next) and the per-phase lessons
