...
*Last updated: 2026-04-27 (Phase 4.2 fully landed — 9 class techniques across all 3 classes: Bloodlust / Hawk's Eye / Arcane Resonance Super stances with `combat_stance` lifecycle, Cleave / Vital Shot / Soulfire Special Attacks via `AttackModifiers`, Iron Bulwark / Shadow Veil / Mirror Ward Special Defenses with persistent armor-split + lingering-dodge effects. New `[🪄 Techniques]` submenu opens edit-in-place with per-fight budget (2/2/1 uses, " × N" suffixes, spent buttons hide). 3 new migrations, 32 new locale keys, ~520 lines added across CombatService / CombatController / ExplorationState / HungerService.)*
